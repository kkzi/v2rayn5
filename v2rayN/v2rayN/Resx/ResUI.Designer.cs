...
namespace v2rayN.Resx {
    ...
    internal class ResUI {
        ...
        /// <summary>
        ///   查找类似 Show log panel 的本地化字符串。
        /// </summary>
        internal static string LogPanelShow {
            get {
                return ResourceManager.GetString("LogPanelShow", resourceCulture);
            }
        }
        
        /// <summary>
        ///   查找类似 Hide log panel 的本地化字符串。
        /// </summary>
        internal static string LogPanelHide {
            get {
                return ResourceManager.GetString("LogPanelHide", resourceCulture);
            }
        }
